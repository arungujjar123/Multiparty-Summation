...
async function testBoth() {
    ...
    const sumRecon = lagrangeAtZero(hSum.slice(0, t).map((y, i) => ({ x: BigInt(i + 1), y })), p);
    ...
    console.log("Reconstructed Mul from result.Tshares:", reconstructFromTshares(result.Tshares, t, p).toString());
